...
from froid.commands.util 	import cli_format
...
from froid 	import cli
from bpyutils._compat		    import iteritems
from froid.__attr__ import __name__
...
"froid". Kindly post an issue at https://github.com/achillesrasquinha/froid/issues""", cli.RED))
        else:
            raise e
